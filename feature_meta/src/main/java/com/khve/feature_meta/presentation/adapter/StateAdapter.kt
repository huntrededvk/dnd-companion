...
class StateAdapter(fragmentManager: FragmentManager, lifecycle: Lifecycle) :
    ...
    override fun createFragment(position: Int): Fragment {
        return MetaListFragment.newInstance(com.khve.feature_meta.domain.entity.PartySizeEnum.entries[position])
    }

    override fun getItemCount(): Int {
        return com.khve.feature_meta.domain.entity.PartySizeEnum.entries.size
    }
}